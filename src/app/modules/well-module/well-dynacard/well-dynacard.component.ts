...
noData(Highcharts);
@Component({
  selector: 'app-well-dynacard',
  templateUrl: './well-dynacard.component.html',
  styleUrls: ['./well-dynacard.component.scss'],
})
export class WellDynacardComponent  implements OnInit {

   /**
   * High Charts starts here
   */
